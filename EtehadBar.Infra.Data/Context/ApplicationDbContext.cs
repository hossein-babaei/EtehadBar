    ...
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Customer>().HasData(
                ...
                new { Id = 4L, Name = "مهرکام پارس", CustomerType = Domain.CustomerType.MehrcomPars, LoadFactorDeductions = 7.8d, HasLoadType = true, HasAddonTonnage = true, HasLoadSleep = true, Status = true, ActiveBank = 45L, RowId = "e70bffab-fa42-4c66-8af8-d7090a6ccbea" });
